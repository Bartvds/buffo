...
}, getConstParse(undefined), getConstReader(undefined));
...
var INT8ARRAY = createType('int8array', false, null, null, null);
var UINT8ARRAY = createType('uint8array', false, null, null, null);
var INT16ARRAY = createType('int16array', false, null, null, null);
var UINT16ARRAY = createType('uint16array', false, null, null, null);

var INT32ARRAY = createType('int32array', false, null, null, null);
var UINT32ARRAY = createType('uint32array', false, null, null, null);
var FLOAT32ARRAY = createType('float32array', false, null, null, null);
var FLOAT64ARRAY = createType('float64array', false, null, null, null);

var UINT8CLAMPEDARRAY = createType('uint8clampedarray', false, null, null, null);
...
function setTypeArr(type, Constr) {
	...
	parseArr[type] = function (source, pointer, push) {
		var length = source.readUInt32BE(pointer);
		pointer += 4;

		var buffer = source.slice(pointer, pointer + length);
...
function stringParse(source, pointer, push) {
	var length = source.readUInt16BE(pointer);
	pointer += 2;
...
function numberParse(source, pointer, push) {
	push(source.readDoubleBE(pointer));
	return pointer + 8;
}
...
function objectParse(source, pointer, push) {
	...
	var object = {};
	for (var i = 0; i < length; i++) {
		var keyLen = source.readUInt32BE(pointer);
		pointer += 4;
...
function dateParse(source, pointer, push) {
	push(new Date(source.readDoubleBE(pointer)));
	return pointer + 8;
}
